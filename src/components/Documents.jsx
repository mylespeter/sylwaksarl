...
// // Mapping des catégories FR/EN vers les catégories internes
// const categoryMap = {
//   'Tout': 'All',
//   'All': 'All',
//   'Entreprise': 'Company',
...
//                 className="w-full pl-10 pr-4 py-3 border border-gray-300 focus:outline-none focus:border-[#ff6b00]"
//               />
//             </div>
...
//                 className="pl-10 pr-4 py-3 border border-gray-300 focus:outline-none focus:border-[#ff6b00] appearance-none bg-white"
//               >
//                 {t.documents.categories.map((cat) => (
...
//             <div className="w-8 h-8 border-4 border-gray-200 border-t-[#ff6b00] animate-spin"></div>
//           </div>
//         ) : (
//           <>
//             {/* Documents Grid */}
...
//                   className="card flex items-start space-x-4 group hover:border-[#ff6b00]/50"
//                 >
//                   <div className="w-12 h-12 bg-red-50 flex items-center justify-center flex-shrink-0">
//                     <FileText className="w-6 h-6 text-red-500" />
//                   </div>
//                   <div className="flex-1 min-w-0">
//                     <h4 className="font-semibold text-[#1a3a6b] text-sm group-hover:text-[#ff6b00] transition-colors break-words">
//                       {doc.name}
//                     </h4>
//                     <div className="flex flex-wrap items-center gap-2 mt-1 text-xs text-gray-500">
//                       <span className="bg-gray-100 px-2 py-0.5">{doc.type}</span>
//                       <span>{doc.size}</span>
//                       <span>{formatDate(doc.created_at || doc.date)}</span>
//                     </div>
//                   </div>
//                   <a
//                     href={doc.file_url || `/documents/${doc.name.toLowerCase().replace(/\s+/g, '-')}.pdf`}
//                     download
//                     className="flex-shrink-0 p-2 bg-[#ff6b00]/10 hover:bg-[#ff6b00] hover:text-white transition-all group/btn"
//                     title="Download"
//                   >
//                     <Download className="w-5 h-5 text-[#ff6b00] group-hover/btn:text-white" />
//                   </a>
//                 </motion.div>
//               ))}
//             </motion.div>
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        {loading ? (
          <div className="flex justify-center py-16">
            <div className="w-12 h-12 border-4 border-gray-200 border-t-[#ff6b00] animate-spin"></div>
          </div>
        ) : (
          <>
            {/* Documents Grid */}
              ...
              {filteredDocs.map((doc, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <span>{t.documents.download || 'Télécharger'}</span>
                  </a>
