...
// import { Upload, Trash2, Edit, Image as ImageIcon, Users, LayoutGrid, LogOut } from 'lucide-react'
...
// const CATEGORIES = ['Construction', 'Mining', 'Industrial', 'Electrical', 'Laboratory']
...
//     setLoading(true)
//     await Promise.all([loadUsers(), loadGallery()])
//     setLoading(false)
//   }
...
//               className={`px-8 py-4 text-sm font-semibold uppercase tracking-wide transition-all flex items-center gap-2 border-b-2 ${
//                 activeTab === 'users'
...
//                 <p className="text-4xl font-bold text-[#1a3a6b]">
//                   {users.filter(u => u.genre === 'M').length}
//                 </p>
//               </div>
//               <div className="bg-gray-50 border-l-4 border-[#ff6b00] p-6 hover:shadow-lg transition-all hover:bg-white">
//                 <p className="text-sm text-gray-500 uppercase tracking-wide font-medium mb-2">Femmes</p>
//                 <p className="text-4xl font-bold text-[#1a3a6b]">
//                   {users.filter(u => u.genre === 'F').length}
//                 </p>
//               </div>
//             </div>
...
//                               className="bg-white text-[#1a3a6b] p-3 hover:bg-[#ff6b00] hover:text-white transition-all shadow-lg"
//                               title="Modifier"
//                             >
...
//                               className="bg-white text-red-600 p-3 hover:bg-red-600 hover:text-white transition-all shadow-lg"
//                               title="Supprimer"
//                             >
...
//                         {/* Info */}
//                         <div className="p-5">
//                           <span className="inline-block bg-[#ff6b00]/10 text-[#ff6b00] text-xs font-bold uppercase tracking-wider px-3 py-1 mb-3">
//                             {image.category}
//                           </span>
...
//                       <p className="text-gray-400 text-sm mt-2">Utilisez le formulaire ci-dessus pour ajouter des images</p>
//                     </div>
//                   )}
//                 </div>
//               )}
