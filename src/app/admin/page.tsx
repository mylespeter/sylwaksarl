...
//   const [activeTab, setActiveTab] = useState<'users' | 'gallery' | 'documents' | 'services' | 'partners' | 'site-images'>(initialTab)
...
//           .from('gallery_images')
//           .update({ title, description, category, image_url: imageUrl, updated_at: new Date().toISOString() })
...
//               { id: 'site-images', icon: Camera, label: 'Images du site' },
//               { id: 'services', icon: Building2, label: 'Services' },
//               { id: 'partners', icon: Handshake, label: 'Partenaires' },
//               { id: 'gallery', icon: LayoutGrid, label: 'Galerie' },
...
//                         <input
//                           type="text"
//                           value={siteImageFormData.alt_text_fr || ''}
//                           onChange={(e) => setSiteImageFormData({...siteImageFormData, alt_text_fr: e.target.value})}
//                           className="w-full border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:border-[#ff6b00]"
...
//                         <input
//                           type="text"
//                           value={siteImageFormData.alt_text_en || ''}
...
//                         <input
//                           type="text"
//                           value={siteImageFormData.alt_text_zh || ''}
...
//                     <button
//                       type="submit"
//                       disabled={uploadingSiteImage || !siteImageFormData.image_url || !siteImageFormData.image_key}
...
//                     {editingSiteImage && (
//                       <button type="button" onClick={resetSiteImageForm} className="border-2 border-[#1a3a6b] text-[#1a3a6b] px-8 py-3 font-semibold hover:bg-[#1a3a6b] hover:text-white transition-all uppercase tracking-wide text-sm rounded-lg">
//                         Annuler
//                       </button>
//                     )}
//                   </div>
...
//                                 <img 
//                                   src={existingImage?.image_url || imageConfig.defaultUrl} 
...
//                       <input
//                         type="text"
//                         value={editingService ? editingService.category : serviceFormData.category}
...
//                       <select
//                         value={editingService ? editingService.icon : serviceFormData.icon}
//                         onChange={(e) => editingService 
...
//                               onChange={(e) => updateTranslation(activeLanguage, 'detailed_description', e.target.value)}
//                               rows={6}
//                               className="w-full border-2 border-gray-200 px-4 py-3 focus:outline-none focus:border-[#ff6b00] transition-colors resize-none"
//                             />
//                           </div>
...
//                                 alt_text_en: '',
//                                 alt_text_zh: '',
//                                 sort_order: serviceImages.length
//                               }
//                               setServiceImages([...serviceImages, newImage])
//                               if (editingService) {
//                                 setEditingService({...editingService, images: [...editingService.images, newImage]})
//                               }
//                             } catch (error) {
//                               console.error('Error uploading image:', error)
//                               alert('Erreur lors de l\'upload de l\'image')
...
//                               <input type="text" placeholder="Alt FR" value={image.alt_text_fr || ''}
//                                 onChange={(e) => {
//                                   const newImages = [...serviceImages]
//                                   newImages[index] = { ...newImages[index], alt_text_fr: e.target.value }
//                                   setServiceImages(newImages)
//                                   if (editingService) setEditingService({...editingService, images: newImages})
//                                 }}
//                                 className="w-full text-xs border px-2 py-1 rounded"
//                               />
//                               <input type="text" placeholder="Alt EN" value={image.alt_text_en || ''}
//                                 onChange={(e) => {
//                                   const newImages = [...serviceImages]
//                                   newImages[index] = { ...newImages[index], alt_text_en: e.target.value }
//                                   setServiceImages(newImages)
//                                   if (editingService) setEditingService({...editingService, images: newImages})
//                                 }}
//                                 className="w-full text-xs border px-2 py-1 rounded"
//                               />
//                               <input type="text" placeholder="Alt ZH" value={image.alt_text_zh || ''}
//                                 onChange={(e) => {
//                                   const newImages = [...serviceImages]
//                                   newImages[index] = { ...newImages[index], alt_text_zh: e.target.value }
//                                   setServiceImages(newImages)
//                                   if (editingService) setEditingService({...editingService, images: newImages})
//                                 }}
//                                 className="w-full text-xs border px-2 py-1 rounded"
...
//                             <div className="w-12 h-12 bg-[#ff6b00]/10 flex items-center justify-center flex-shrink-0 text-[#ff6b00] rounded-lg">
...
//                                   <span key={t.language} className="text-xs bg-gray-100 px-2 py-0.5 rounded">
...
//                                 <img key={i} src={img.image_url} alt="" className="w-8 h-8 object-cover rounded" />
//                               ))}
//                               {service.images.length > 3 && (
//                                 <span className="w-8 h-8 bg-gray-200 rounded flex items-center justify-center text-xs">+{service.images.length - 3}</span>
//                               )}
//                             </div>
//                           )}
...
//                       {partner.website && (
//                         <a href={partner.website} target="_blank" rel="noopener noreferrer" className="text-xs text-blue-600 hover:underline mt-1 inline-block">Visiter</a>
//                       )}
//                       <div className="flex gap-2 mt-4 pt-4 border-t border-gray-100">
...
//             <div className="bg-white border border-gray-200">
//               <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
//                 <h2 className="text-lg font-bold text-[#1a3a6b] uppercase">{editingImage ? 'Modifier l\'image' : 'Ajouter une nouvelle image'}</h2>
//               </div>
//               <div className="p-6">
//                 <form onSubmit={handleUpload} className="space-y-6">
//                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                     <div>
//                       <label className="block text-sm font-semibold text-[#1a3a6b] uppercase mb-2">Titre</label>
...
//                   </div>
//                   <div>
//                     <label className="block text-sm font-semibold text-[#1a3a6b] uppercase mb-2">Description</label>
...
//                           <button onClick={() => editImage(image)} className="bg-white text-[#1a3a6b] p-3 hover:bg-[#ff6b00] hover:text-white transition-all shadow-lg rounded-lg">
//                             <Edit className="w-5 h-5" />
//                           </button>
//                           <button onClick={() => deleteImage(image)} className="bg-white text-red-600 p-3 hover:bg-red-600 hover:text-white transition-all shadow-lg rounded-lg">
//                             <Trash2 className="w-5 h-5" />
//                           </button>
//                         </div>
//                       </div>
//                       <div className="p-5">
//                         <span className="inline-block bg-[#ff6b00]/10 text-[#ff6b00] text-xs font-bold uppercase tracking-wider px-3 py-1 mb-3 rounded">{image.category}</span>
//                         <h3 className="text-base font-bold text-[#1a3a6b] mb-2">{image.title}</h3>
//                         {image.description && <p className="text-sm text-gray-600 leading-relaxed line-clamp-2">{image.description}</p>}
//                       </div>
//                     </div>
//                   ))}
//                 </div>
